...
const ASSETS=["./","./index.html","./style.css?v=20260823-3","./steward-v5.css?v=20260903-7","./nutrition-v7.css?v=20260903-4","./steward-v5.js?v=20260903-1","./app-icon-512.png","./manifest.webmanifest"];
...
self.addEventListener("push",event=>{const data=event.data?.json?.()||{};event.waitUntil(self.registration.showNotification(data.title||"健身大脑",{body:data.body||"拥有自律，生活治愈。今天的训练已经准备好。",icon:"./app-icon-512.png",badge:"./app-icon-512.png",tag:data.tag||"steward-push",data:{url:data.url||"./"}}))});
