const CACHE="steward-v7-20260902-2";
const ASSETS=["./","./index.html","./style.css?v=20260823-3","./steward-v5.css?v=20260902-5","./nutrition-v7.css?v=20260902-2","./steward-v5.js?v=20260902-5","./app-icon-512.png","./manifest.webmanifest"];
