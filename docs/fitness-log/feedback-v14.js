...
const stewardStyle=document.createElement("link");stewardStyle.rel="stylesheet";stewardStyle.href="./steward-v3.css?v=20260902-1";document.head.appendChild(stewardStyle);
const stewardScript=document.createElement("script");stewardScript.src="./steward-v3.js?v=20260902-1";stewardScript.defer=true;stewardScript.async=false;document.body.appendChild(stewardScript);
